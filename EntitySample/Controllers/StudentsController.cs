...
namespace EntitySample.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var student = await _context.Phonebook
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var student = await _context.Phonebook.FindAsync(id);
            if (student == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Phonebook'  is null.");
            }
            var student = await _context.Phonebook.FindAsync(id);
            if (student != null)
            {
                _context.Phonebook.Remove(student);
            }
